...
// Tool Versions: 
// Description: 
// Debounces a mechanical push button and generates clean,
// one-clock-cycle pulses on both rising and falling edges.
//
// Functionality:
// 1. Synchronizes the asynchronous button input to the clock domain
// 2. Removes contact bounce using a time-based filter
// 3. Outputs single-cycle pulses for button press and release events
//////////////////////////////////////////////////////////////////////////////////
